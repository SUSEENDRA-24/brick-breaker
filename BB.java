...
public class BB extends JPanel implements KeyListener,
...
// /////////// =================================
   if (count == Brick.length) {// check if ball hits all bricks
    bricksOver = true;
    status = "YOU WON :) GAMESCORE:"+score;
    repaint();
    break;
   }
   // /////////// =================================
   ...
   if (Ball.y <= 0) {// ////////////////|| ball + Ball.height >= 250
    movey = -movey;
   }// if ends here.....
   if (Ball.y >= 250) {// when ball falls below bat game is over...
    ballFallDown = true;
    status = "YOU LOST :( GAMESCORE:"+score;
    repaint();
